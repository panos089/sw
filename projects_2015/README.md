...
Σε αυτό το φάκελο δημιουργείτε ένα φάκελο με τον αριθμό μητρώου σας και βάζετε μέσα όλα τα παραδοτέα σε αντίστοιχους φακέλους μέσα στο φάκελό σας, όπως είναι το παράδειγμα με το φάκελο Π201200.

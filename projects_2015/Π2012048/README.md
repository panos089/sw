...
Οι βελτιώσεις και επεκτάσεις που μπορεί να δεχθεί η εφαρμογή είναι πολλές και εξαρτώνται απο την φαντασία του εκάστοτε developer. Μερικές απο αυτές που θα ήταν χρήσιμες τόσο λειτουργικά όσο και αισθητικά είναι:
	...
	ii) Τα locations να οριστούν με μεγαλύτερη ακρίβεια.

	iii) Tweet filtering προκειμένου να διατηρούνται μόνο τα τweet που η αξία τους σε πληροφορία να είναι όσο το δυνατόν μεγαλύτερη

	iv) To Frontend & η mobile εφαρμογή να αξιοποιεί τις χρονικές πληροφορίες που κρατώνται για κάθε trend/tweet (χρονική αναζήτηση, θέματα συζήτησης ανα χώρα σε διάφορα χρονικά διστήματα κλπ)

	v) Η Mobile εφαρμογή να στηθεί και σε άλλα λειτουργικά συστήματα για mobile συσκευές

	vi) H Mobile εφαρμογή να υλοποιηθεί με πιο αισθητικά προσιτό Visualization των πληροφοριών
